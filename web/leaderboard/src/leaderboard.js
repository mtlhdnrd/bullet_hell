class Player {
    constructor(username, points, winrate, all_games_played, kills, deaths, most_used_music_id, current_music_id, active_skin_id) {
    ...
    $.ajax({
        ...
        success: function (data, textStatus, xhr) {
            $.each(data, function(index, player){
                leaderboard.push(new Player(player.username, player.points, player.winrate, player.all_games_played, player.kills, player.deaths, player.most_used_music_id, player.current_music_id, player.active_skin_id));
            });
        }
        }).then((result) => {
